...
class TestEBest(unittest.TestCase):
    ...
    def test_get_credit_trend_by_code(self):
        ...
        result = self.ebest.get_credit_trend_by_code("005930", "20210203")
        assert result is not None
        print(result)

    def test_get_short_trend_by_code(self):
        print(inspect.stack()[0][3])
        result = self.ebest.get_short_trend_by_code("005930", sdate="20210203", edate="20210203")
        assert result is not None
        print(result)

    def test_get_agent_trend_by_code(self):
        print(inspect.stack()[0][3])
        result = self.ebest.get_agent_trend_by_code("005930", fromdt="20210203", todt="20210203")
        assert result is not None
        print(result)
